...
public class AmbienteRuinas extends Ambiente {
    ...
    public AmbienteRuinas() {
        ...
        super.recursosDisponiveis.add(new Alimento("Cogumelo", 1.0,10, 10, true));
        super.recursosDisponiveis.add(new Alimento("Cebola", 0.1,1, 1, true));
        super.recursosDisponiveis.add(new Alimento("Tomate", 0.1,1, 1, false));
        super.recursosDisponiveis.add(new Alimento("Cereal", 0.1,5, 1, false));
        super.recursosDisponiveis.add(new Alimento("Cereal", 0.1,5, 1, true));
